...
### `Midi2ABC.exe` and `easyABC_modified/`
MIDI to ABC converter (executable), supports selecting file(s) and drag and drop.
*All files are generated in folder alongside the exe.*
<br><br>
