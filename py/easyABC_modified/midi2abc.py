...
# Add local midi/ folder to import path
sys.path.append(str(Path(__file__).resolve().parent / "midi"))
...
def main(argv):
    ...
    # If no title was given, use the base filename as the title
    if not title:
        title = os.path.splitext(os.path.basename(output_filename or filename))[0]
